...
module VLC
 module Media
  ...
  attach_function :libvlc_media_player_set_agl, [ :pointer, :uint32 ], :void
  attach_function :libvlc_media_player_get_agl, [ :pointer ], :uint32
  attach_function :libvlc_media_player_set_xwindow, [ :pointer, :uint32 ], :void
  attach_function :libvlc_media_player_get_xwindow, [ :pointer ], :uint32
  ...
  attach_function :libvlc_media_player_get_length, [ :pointer ], :int64
  attach_function :libvlc_media_player_get_time, [ :pointer ], :int64
  attach_function :libvlc_media_player_set_time, [ :pointer, :int64 ], :void
  ...
  attach_function :libvlc_media_player_get_state, [ :pointer ], VLC::Types::Libvlc_state_t
  ...
  attach_function :libvlc_audio_get_delay, [ :pointer ], :int64
  attach_function :libvlc_audio_set_delay, [ :pointer, :int64 ], :int
